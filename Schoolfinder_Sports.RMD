...
write.xlsx(Baseball_final, 'R:\\Specialists Transfer\\Ken\\GitHub\\Schoolfinder_Sports\\Baseball_final.xlsx')
```
...
write.csv(All_Sports, "R:\\Specialists Transfer\\Ken\\GitHub\\Schoolfinder_Sports\\All_Sports_final.csv", row.names=FALSE)
```
